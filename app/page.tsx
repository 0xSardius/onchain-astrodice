    ...
    return (
      <div className="flex flex-col items-center min-h-[calc(100vh-9rem)] px-4 py-6">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-3">
            {/* Primary CTA */}
            <button className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all">
              <span className="mr-2">&#x2728;</span>
              Get AI Reading · $2
            </button>
